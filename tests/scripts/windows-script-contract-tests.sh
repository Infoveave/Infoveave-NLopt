...
grep -q 'vswhere.exe' "$repository_root/scripts/resolve-dumpbin.ps1"
grep -q 'Hostx64\\x64\\dumpbin.exe' "$repository_root/scripts/resolve-dumpbin.ps1"
grep -q 'resolve-dumpbin.ps1' "$repository_root/scripts/build-native.ps1"
grep -q 'resolve-dumpbin.ps1' "$repository_root/scripts/verify-runtime-bundle.ps1"
...
grep -q 'duplicate file entries' "$repository_root/scripts/verify-runtime-bundle.ps1"
grep -q "nativeVersion = '2.11.0'" "$repository_root/scripts/package-runtime-bundle.ps1"
grep -q "runtimeCompatibility = 'managed-api-v1'" "$repository_root/scripts/package-runtime-bundle.ps1"
